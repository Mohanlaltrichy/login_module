				...
				<div class="row">
					<div class="col-lg-12 ">
						<div class="row">
							...
							<?php } ?>
							<!--  -->
							<?php if (session('model_builder_module_view') == '1') { ?>
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="em-feature-box" onclick="open_model_builder()" target="_blank">
										<div class="em-feature-box-inner">
											<div class="em-feature-icon">
												<img src="<?php echo base_url(); ?>assets/images/model_builder.png" width='90px;' height='90px;' alt="user-img">
											</div>
											<div class="em-content-text">
												<div class="em-feature-title">
													<h2>Model Builder</h2>
...
<script>
	...
	function open_model_builder(){
		window.open('<?= OPEN_MODEL_BUILDER . $login_key; ?>', '_blank');
	}
</script>