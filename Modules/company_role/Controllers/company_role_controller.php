...
class company_role_controller extends BaseController
{
    ...
    public function index()
    {
        try 
        {
            ...
            $data_aggregation_module_like = [
                'tcp.page_name' => 'aggregation'
            ];

            $data_aggregation_module_data = $this->company_role_model->get_page_details($data_aggregation_module_like);
            ...
            $dashboard_status_module_like = [
                'tcp.page_name' => 'dashboard'
            ];

            $dashboard_module_data = $this->company_role_model->get_page_details($dashboard_status_module_like);

            $reports_status_module_like = [
                'tcp.page_name' => 'reports'
            ];
            ...
            $subscription_status_module_like = [
                'tcp.page_name' => 'subscription'
            ];
            ...
            $data = array(
                ...
                'data_aggregation_module_data' => $data_aggregation_module_data,              
    ...
    public function company_role_save()
    {
        try 
        {
            if(session('roles_add_edit') == '1')
            {
                ...
                $groups_checkbox_id = $this->request->getPost("groups_checkbox_id");
                $groups_all_checkbox_value = $this->request->getPost("groups_all_checkbox_value");
                $groups_checkbox_view = $this->request->getPost("groups_checkbox_view");
                $groups_checkbox_edit = $this->request->getPost("groups_checkbox_edit");
                $groups_checkbox_delete = $this->request->getPost("groups_checkbox_delete");
                ...
                $aggregation_checkbox_id = $this->request->getPost("aggregation_checkbox_id");
                $aggregation_all_checkbox_value = $this->request->getPost("aggregation_all_checkbox_value");        
                $aggregation_checkbox_view = $this->request->getPost("aggregation_checkbox_view");            
                $aggregation_checkbox_edit = $this->request->getPost("aggregation_checkbox_edit");          
                $aggregation_checkbox_delete = $this->request->getPost("aggregation_checkbox_delete");
                ...
                $dashboard_checkbox_id = $this->request->getPost("dashboard_checkbox_id");     
                $dashboard_all_checkbox_value = $this->request->getPost("dashboard_all_checkbox_value");
                $dashboard_checkbox_view = $this->request->getPost("dashboard_checkbox_view");          
                $dashboard_checkbox_edit = $this->request->getPost("dashboard_checkbox_edit");            
                $dashboard_checkbox_delete = $this->request->getPost("dashboard_checkbox_delete");
                $reports_checkbox_id = $this->request->getPost("reports_checkbox_id");     
                $reports_all_checkbox_value = $this->request->getPost("reports_all_checkbox_value");
                ...
                $subscription_checkbox_id = $this->request->getPost("subscription_checkbox_id");     
                $subscription_all_checkbox_value = $this->request->getPost("subscription_all_checkbox_value");
