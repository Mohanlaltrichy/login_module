...
class company_role_controller extends BaseController
{
    ...
    public function company_role_edit($id = 0)
    {
        try
        {
            ...
            $roles_details = $this->company_role_model->GetTableValue('tbl_roles', 'id,role_name,description,roles_all_pages,users_all_pages,opc_all_pages,mqtt_all_pages,http_all_pages,tag_all_pages,bulk_import_status_all_pages,dashboard_status_all_pages,status', $role_data_whereConditions);
