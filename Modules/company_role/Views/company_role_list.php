                ...
                <div class="card">               
                    ...
                    <div id="heading1">
                        ...
                        <span class="float-right" style="font-size:12px;color:red;">
                            <?php 
                            if(session('roles_view_and_edit_edit') != '1' && session('roles_view_and_edit_delete') != '1')
                            {
                                echo EDIT_AND_DELETE_PERMISSION;
                            }
                            else if(session('roles_view_and_edit_edit') != '1')
                            {
                                echo EDIT_PERMISSION;
                            }
                            else if(session('roles_view_and_edit_delete') != '1')
                            {
