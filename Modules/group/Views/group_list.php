...
<div class="wrapper">
    <div class="container-fluid-custom">
        ...
        <div id="custom_error_alert_controller_message">
            <?php
            $session = session();
            if ($session->getTempdata('group_deleted_success')) {
                echo $customlibraries->global_alert_msg('success', $session->getTempdata('group_deleted_success'));
            }
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title m-0" id="mySmallModalLabel">Groups</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                Are you sure delete the group?
                </br><span class='font-red'>user map to this group will be inactive</span>
            </div>
