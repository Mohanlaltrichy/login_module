...
$routes->get('/', 'login_controller::login',["filter" => "isloggedfilter"]);
...
//HMVC Add this to Footer, Including all module routes Start
...
//HMVCAdd this to Footer, Including all module routes End
